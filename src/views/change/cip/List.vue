      ...
      <a-row :gutter="48" style="margin-top: 10px">
        <a-col :md="24" :sm="24" style="margin-bottom: 10px">
          <a-button
            type="success"
            @click="handleToAdd"
            :disabled="!queryParam2.contractGuid || (professionType.indexOf(contractSelected.contractProfession) > -1 && !contractSelected.bdIsComplete)">
            新增
          </a-button>
          <a-button
            type="success"
            ...
            @click="handleCipToVo"
            :disabled="tableSelected.cipGuid == undefined || tableSelected.auditStatus.indexOf('已审核') < 0 || tableSelected.cipType === 131">
            CIP转VO
          </a-button>
          <a-button type="success" style="margin-left: 20px"
                    :disabled="tableSelected.cipGuid == undefined || tableSelected.auditStatus !== '已审核' || tableSelected.voStatus !== '待确认'">
            现场签证
          </a-button>
          <a-button
            type="success"
            style="margin-left: 20px"
            :disabled="contractSelected.contractGuid == undefined || professionType.indexOf(contractSelected.contractProfession) < 0"
            @click="handleDesign"
          >施工组织设计
          </a-button>
        </a-col>
