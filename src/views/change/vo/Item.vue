...
<script>
    import BaseInfo from '@/views/change/vo/components/BaseInfo'
    import CostEstimates from '@/views/change/vo/components/CostEstimates'
    import BudgetList from '@/views/change/vo/components/BudgetList'
    import AttachmentData from '@/views/change/vo/components/AttachmentData'
    import AttachmentList from '@/views/change/vo/components/AttachmentList'
    import Process from '@/views/change/vo/components/Process'
    export default {
