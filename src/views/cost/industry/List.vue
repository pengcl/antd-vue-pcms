  ...
  <page-header-wrapper>
    <a-card :bordered="false">
      ...
      <div class="table-operator">
        ...
        <a-button :disabled="!queryParam.ProjectGUID || this.$refs.table._data.localDataSource.length < 1"
                  type="success" @click="addBatch" v-if="ac('ADD')">新增审核
        </a-button>
        <a-button :disabled="!queryParam.ProjectGUID" type="success" @click="viewBatch" v-if="ac('VIEW')">查看审核
        </a-button>
