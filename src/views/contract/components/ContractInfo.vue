    ...
    <a-row :gutter="48">
      ...
      <a-col :md="12" :sm="24">
        <a-form-item
          label="原合同金额"
        >
          <a-input-number min="0"></a-input-number> 元
        </a-form-item>
      </a-col>
      <a-col :md="12" :sm="24">
        <a-form-item
      ...
      <a-col :md="12" :sm="24">
        <a-form-item
          label="缺陷责任期"
        >
          <a-input-number min="0"></a-input-number> 年
        </a-form-item>
      </a-col>
      <a-col :md="12" :sm="24">
        <a-form-item
      ...
      <a-col :md="12" :sm="24">
        <a-form-item
          label="出差次数"
        >
          <a-input-number min="0"></a-input-number> 次
        </a-form-item>
      </a-col>
      <a-col :md="24" :sm="24">
        保修金/保固金/保留金：
      ...
      <a-col :md="12" :sm="24">
        <a-form-item
          label="工程延误赔偿">
          <a-input-number min="0"></a-input-number> 元 / 日
        </a-form-item>
      </a-col>
      <a-col :md="12" :sm="24">
        <a-form-item
          ...
          <tr>
            ...
            <td>
              <a-select
                ...
                v-decorator="['paymentUser', { rules: [{required: true, message: '请选择'}] }]">
                <a-select-option value="1">已提交</a-select-option>
                <a-select-option value="2">未提交</a-select-option>
              </a-select>
            </td>
            <td>
              <a-date-picker></a-date-picker>
