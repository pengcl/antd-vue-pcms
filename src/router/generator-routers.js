...
import * as loginService from '@/views/user/user.service'
// eslint-disable-next-line
...
const constantRouterComponents = {
  ...
  // 你需要动态引入的页面组件
  // dashboard
  'Participate': () => import('@/views/dashboard/Participate'),
  'Tasks': () => import('@/views/dashboard/Tasks'),
  ...
  'ChangeCertificate':() => import('@/views/change/Certificate'),

  // cost
  'CostEnactList': () => import('@/views/cost/enact/List'),
  'CostEnactItem': () => import('@/views/cost/enact/Item'),
  'CostEnactCollect': () => import('@/views/cost/enact/Collect'),
  'CostEnactImport': () => import('@/views/cost/enact/Import'),
  'CostEnactSubImport': () => import('@/views/cost/enact/SubImport'),
